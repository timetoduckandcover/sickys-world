<header id="header" class="header-04 boxed <?php echo esc_attr( facewp_abbey_get_overlay_header() ? 'header-overlay' : '' ); ?>">
    ...
    <div class="container header-middle hidden-sm-down">
        <div class="row row-md-center">
            ...
            <div class="col-md-6 center-xs">
                <div id="header-search" class="search-type-2">
        ...
        <div class="menu-inner">
            <div class="header-nav hidden-sm-down">
                <div class="row">
                    ...
                    <?php endif; ?>
                    <div class="<?php echo esc_attr( has_nav_menu( 'vertical_menu' ) ? 'col-md-9' : 'col-md-12' ); ?> end-xs">
