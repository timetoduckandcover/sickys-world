    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <?php
                if ( is_day() ) :
                    echo _e( '<span>Daily Archives:</span>', 'facewp-abbey' );
                    printf( __( '<h1>%s</h1>', 'facewp-abbey' ), get_the_date() );

                elseif ( is_month() ) :
                    echo _e( '<span>Monthly Archives:</span>', 'facewp-abbey' );
                    printf( __( '<h1>%s</h1>', 'facewp-abbey' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'facewp-abbey' ) ) );

                elseif ( is_year() ) :
                    echo _e( '<span>Yearly Archives:</span>', 'facewp-abbey' );
                    printf( __( '<h1>%s</h1>', 'facewp-abbey' ), get_the_date( _x( 'Y', 'yearly archives date format', 'facewp-abbey' ) ) );

                else :
                    _e( '<h1>Archives:</h1>', 'facewp-abbey' );
